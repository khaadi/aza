insert into article(id,description,genre, name, image_url, color_id)
VALUES (1,'Napoleon I Bonaparte was a French commander and statesman. Emperor of France (1804-1814 and in March -June 1815). In 1799, he committed a coup d''etat and became the first consul; ' ||
          ...
          'Carlo Buonaparte, who survived eight of his twelve children, was rewarded for his loyalty to France with the opportunity to send his eldest sons, Joseph and Napoleon, to college in 1779.' ||
          'Two months later, Napoleon transferred to the military school in Brienne. ' ||
          'In 1784, having received the rank of cadet, he continued his studies at the military school in Paris. ' ||
     ...
     'HISTORY', 'The Life and Reign of Napoleon Bonaparte', 'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704792120/diho8ghkt0fwxom6sznt.webp', 1),
       (2, 'Aristotle is rightfully considered the greatest encyclopedist of antiquity and the most significant systematizer of philosophical and scientific knowledge accumulated before him. ' ||
           'He is also known as the tutor of the great commander Alexander the Great. ' ||
           'Appreciating Plato highly, he criticized his teaching, uttering the catch phrase: "Plato is my friend, but the truth is dearer." ' ||
           'Developing his views on being, Aristotle criticizes Plato''s teaching about the existence of ideas as completely independent pre-natural entities. ' ||
           'In his opinion, such ideas represent only concepts reflecting the material world, i.e. they are like copies of things, but not the other way around. Aristotle formulates his idea of being perceived through sensations. ' ||
           'This objective, sensual world is the primary reality, nature, ' ||
           'which is not defined by anyone.Matter is the universal cause, because without it there is no existence, Aristotle believes. The shape plays the role of a feature. ' ||
           'Thanks to it, matter is realized and a specific object is formed. In other words, the form is represented as the sum of the properties that distinguish' ||
           'one object from another, and is the essence of both the object and being as a whole. Thanks to the form, the thing is what it really is.The human soul, as well as its essence or body shape, gives meaning and direction to life. ' ||
           '"The soul is the cause and the beginning of a living body..." As form dominates matter, so, ' ||
           ...
           'Man, in his opinion, is a "political animal", which has an instinctive tendency towards "cohabitation". "The one who cannot enter and form part of a certain community, ' ||
           'who does not need anyone or anything, is sufficient for himself, then, not being part of the state, he is either a beast or a God."The purpose of the State is to ensure the happiness of all citizens, which include only those who own property and participate in the management of society.' ||
           'Slaves were not citizens.Aristotle distinguished 6 forms of the state: 3 correct: aristocracy, monarchy and polity, and 3 incorrect: tyranny, oligarchy and democracy. ' ||
    ...
    'PHILOSOPHY', 'The Philosophy of Aristotle', 'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704791729/qrwwk1ocfyx2gqpcrr4a.jpg', 2),
       (3,'Chekhov''s humor can be called ruthless and even unscrupulous. Remember, for example, the story "Death of an official", the hero of which sneezed at the general and was so worried about it that he died. Such black humor is often explained by the fact that Chekhov was a doctor by profession, and representatives of this profession are not considered to be too sensitive. ' ||
            'This is confirmed by another doctor from Russian literature, Mikhail Bulgakov, who is also known for his inimitable irony and ruthlessness towards human vices.Chekhov laughs at something that is not accepted and even indecent to laugh at today. ' ||
            'He constantly violates the reader''s boundaries. In modern society, they carefully touch on such things as stupidity or lack of will, ' ||
            'considering them subjective and abstract. But Chekhov is not confused by this. His characters get into awkward situations, and sometimes even experience tragedy precisely because of their weakness of character or their narrow-mindedness. ' ||
            'He wrote: "It''s not about pessimism or optimism, but the fact that 99 out of 100 have no mind."According to Chekhov, "the art of writing is the art of shortening," ' ||
            'but brevity does not equal simplicity. To express a complex idea succinctly and accurately, the author needs not only scissors, with which he cuts everything superfluous, but also other tools. Therefore, in humorous prose, Chekhov resorts to various artistic techniques, both innovative and recognizable. ' ||
            'For example, the famous "Thick and Thin" from the school literature list is based on an almost fable allegory. ' ||
            'In "Chameleon" there is a transparent satire on worship. ' ||
            'And in the story "The Horse''s Name", the writer attracts a linguistic game.But still, Chekhov is known to the whole world primarily as a playwright. Chekhov''s plays may seem rather sad — even if he himself calls them comedies. Sometimes it''s not clear where to laugh at all. "Whether to go for tea or hang yourself," this depressing statement of the writer can describe the atmosphere of his plays.',
    'LITERATURE', 'Why is Chekhov not so simple?', 'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704792185/mtydxkki4fxvrxckrtjg.webp', 3),
       (4, 'Why is Bulgakov''s famous novel called "The Master and Margarita", and what is this book really about? It is known that the idea of creation was born in the author after his fascination with mysticism of the XIX century.Legends about the devil, Jewish and Christian demonology, treatises on God – all this is present in the work. ' ||
            'The most important sources consulted by the author were the works ' ||
            '"The History of Human relations with the Devil" by Mikhail Orlov and the book by Amfiteatrov "The Devil in everyday life, legend and literature of the Middle Ages". As you know, the "Master and Margarita" had several editions. ' ||
             'They say that the first one, which the author worked on in 1928-1929, had nothing to do with either the Master or Margarita, and was called "The Black Magician", "The Juggler with the Hoof". ' ||
            'That is, the central figure and essence of the novel was precisely the Devil - a kind of Russian version of the work "Faust". ' ||
             'Bulgakov personally burned the first manuscript after the prohibition of his play "The Cabal of the Saints." ' ||
              'The writer informed the government about this: "And personally, with my own hands, I threw a draft of a novel about the devil into the stove!" The second edition was also dedicated to the ' ||
    ...
    'LITERATURE', 'Why did you misread "The Master and Margarita"?', 'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704792262/lusehoraekwolalclpgv.webp', 4),
    ...
    'HISTORY', 'The history of the Ancient World', 'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704792373/ne4a2p1scj3mjgbok1sw.webp', 5) on conflict do nothing;
---------------    дальше идет раздел задач и ответов    -----------------

INSERT INTO quiz(id, genre, name, description, image_url, color_id)
VALUES (1,'HISTORY', 'Quiz "History"', '"History" is a fascinating quiz designed for those who are fascinated by the past and are looking to deepen their knowledge of history. From ancient civilizations to modern events, this quiz provides a unique opportunity to test your erudition and versatile knowledge of key moments in human history.',
        'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704885347/ngxnrgsw5e0sv5h5dbvh.jpg', 1),
       (2,'PHILOSOPHY', 'Quiz "Philosophy"', '"Philosophy" is an intriguing quiz designed for those who seek a deeper understanding of the basic concepts and ideas of philosophy.  From ancient to modern times, this quiz provides a unique opportunity to explore the world of abstract ideas and great thinkers.',
        'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704885393/czrrdle6r9ol6ewbwqup.jpg', 2),
       (3, 'MUSIC', 'Quiz "Music"', '"Music" is an exciting quiz designed for anyone who appreciates the magic of sounds and exploring the world of musical genres. From classics to modern hits, this quiz provides a fascinating journey through the multifaceted aspects of music.',
        'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704885259/td2tfdo4dnrh9gxnnxw8.jpg', 3),
       (4, 'LITERATURE', 'Quiz "Literature"', '"Literature" is an exciting quiz designed for those who are fascinated by the world of words and the art of literature.  From classic works to modern literary movements, this quiz takes you on a fascinating journey through the pages of literary history.',
        'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704885443/gkwjgsfc75ebmk1sk4je.jpg', 4) on conflict do nothing;
INSERT INTO question(quiz_id, name, answer_true, first_answer_false, second_answer_false, third_answer_false)
VALUES  (1,'Which of the eras is not real?', 'Gold', 'Iron', 'Bronze', 'Stone'),
        (1,'Where did civilization first form?', 'Ancient East', 'Ancient Rome', 'Ancient Greece', 'Ancient China'),
        (1,'Where is Bonoparte from?', 'France', 'England', 'Greece', 'Germany'),
        (1,'The years of the great Farnese revolution?', '1789-1794', '1789-1795', '1798-1812', '1779-1784'),
        (1,'When did World War II start?', '1-September 1939', '1-September 1941', '7-September 1941', '7-September 1939'),
        (2,'Who is Aristotle?', 'Philosov', 'Scientist', 'Writer', 'Historian'),
        ...
        (4, 'Which of the following genres is usually characterized by a high degree of emotional tension, conflict, and resolution of contradictions?',
            'Drama', 'Lyrics', 'Thriller', 'Detective') on conflict do nothing;