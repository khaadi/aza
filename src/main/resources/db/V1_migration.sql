...
VALUES (1, 'Наполеон I Бонапарт - французский полководец и государственный деятель. Император Франции (1804-1814 и в марте - июне 1815). ' ||
     ...
     'HISTORY', 'Жизнь и правление Наполеона Бонапарта', 'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704792120/diho8ghkt0fwxom6sznt.webp', 1),
    ...
    'PHILOSOPHY', 'Философия Аристотеля', 'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704791729/qrwwk1ocfyx2gqpcrr4a.jpg', 2),
    ...
    'LITERATURE', 'Почему Чехов не так прост?', 'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704792185/mtydxkki4fxvrxckrtjg.webp', 3),
    ...
    'LITERATURE', 'Почему вы неправильно читали «Мастера и Маргариту»?', 'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704792262/lusehoraekwolalclpgv.webp', 4),
       (5, 'Древнейшие люди были больше похожи на животных, чем на нас, но благодаря постоянному стремлению к новому и упорному труду они сумели выжить, научились заботиться о детях, больных, слабых, ' ||
           ...
           'Но развитие человечества не остановилось. Наступила эпоха Средневековья.',
    'HISTORY', 'История Древнего мира', 'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704792373/ne4a2p1scj3mjgbok1sw.webp', 5) on conflict do nothing;
---------------    дальше идет раздел задач и ответов    -----------------

INSERT INTO quiz(id, genre, name, description, image_url, color_id)
VALUES (1,'HISTORY', 'Квиз "История"', '"История" - это увлекательный квиз, предназначенный для тех, кто увлечен прошлым и стремится углубить свои знания в области истории. ' ||
                                       'От древних цивилизаций до современных событий, этот квиз предоставляет уникальную возможность проверить свою эрудицию и разносторонние знания о ключевых моментах истории человечества.',
        'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704885347/ngxnrgsw5e0sv5h5dbvh.jpg', 1),
       (2,'PHILOSOPHY', 'Квиз "Философия"', '"Философия" - это интригующий квиз, созданный для тех, кто стремится глубже понять основные концепции и идеи философии. ' ||
                                            'От древности до современности, этот квиз предоставляет уникальную возможность исследовать мир абстрактных идей и великих мыслителей.',
        'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704885393/czrrdle6r9ol6ewbwqup.jpg', 2),
       (3, 'MUSIC', 'Квиз "Музыка"', '"Музыка" – это захватывающий квиз, предназначенный для всех, кто ценит волшебство звуков и исследование мира музыкальных жанров. ' ||
                                     'От классики до современных хитов, этот квиз предоставляет увлекательное путешествие по многогранным аспектам музыки.',
        'http://res.cloudinary.com/dovfdzzuz/image/upload/v1704885259/td2tfdo4dnrh9gxnnxw8.jpg', 3),
       (4, 'LITERATURE', 'Квиз "Литература"', '"Литература" – это захватывающий квиз, предназначенный для тех, кто увлечен миром слов и искусства литературы. ' ||
                                              'От классических произведений до современных литературных течений, этот квиз приглашает вас на увлекательное путешествие по страницам литературной истории.',
...
VALUES  (1,'Какой из эпох не настоящий?', 'Золотой', 'Железный', 'Бронзовый', 'Каменный'),
        ...
        (2,'Какие из причин не учил Аристотель?', 'Бытие', 'Материя', 'Форма', 'причина/следствие'),
        (3, 'Какой из следующих жанров музыки характеризуется использованием электронных инструментов и компьютерных технологий?',
            'Электроника', 'Джаз', 'Рок', 'Кантри'),
        (3, 'Какой жанр музыки традиционно ассоциируется с Бразилией и известен своими латиноамериканскими ритмами?',
            'Самба', 'Регги', 'Кантри', 'Фанк'),
        (3, ' Какой стиль музыки характеризуется тяжелыми гитарными риффами, агрессивными текстами и мощным вокалом?',
            'Металл', 'Хип-хоп', 'Поп', 'Джаз'),
        (3, 'Какой жанр музыки был популярен в 1970-х и характеризуется длинными инструментальными соло и сложными музыкальными структурами?',
            'Прогрессивный рок', 'Рэп', 'Диско', 'Блюз'),
        (3, 'Какой из перечисленных жанров музыки имеет корни в афроамериканской культуре и включает в себя подстили, такие как блюз и соул?',
            'Джаз', 'Кантри', 'Регги', 'Фанк'),
        (4, 'Какой из следующих жанров характеризуется вымышленными сюжетами и персонажами, а также может включать элементы фэнтези и научной фантастики?',
            'Фантастика', 'Документальная проза', 'Реализм', 'Поэзия'),
        (4, 'Какой литературный жанр описывает реальные события и факты, представляя их в художественной форме?',
            'Документальная проза', 'Роман', 'Фэнтези', 'Трагедия'),
        (4, 'Какой жанр характеризуется преимущественно использованием юмора, комических элементов и часто имеет смешанный сюжет?',
            'Комедия', 'Трагедия', 'Драма', 'Эпопея'),
        (4, 'Какой литературный жанр охватывает произведения, основанные на реальных исторических событиях и фигурах, но включающие элементы вымысла?',
            'Исторический роман', 'Фэнтези', 'Поэзия', 'Эссе'),
        (4, 'Какой из перечисленных жанров обычно характеризуется высокой степенью эмоциональной напряженности, конфликтами и разрешением противоречий?',
            'Драма', 'Лирика', 'Триллер', 'Детектив') on conflict do nothing;