insert into article(id, description,genre, name)
VALUES (1, 'Наполеон I Бонапарт - французский полководец и государственный деятель. Император Франции (1804-1814 и в марте - июне 1815). ' ||
     ...
     'HISTORY', 'Жизнь и правление Наполеона Бонапарта'),
    ...
    'PHILOSOPHY', 'Философия Аристотеля'),
    ...
    'LITERATURE', 'Почему Чехов не так прост?'),
    ...
    'LITERATURE', 'Почему вы неправильно читали «Мастера и Маргариту»?'),
    ...
    'HISTORY', 'История Древнего мира') on conflict do nothing;
